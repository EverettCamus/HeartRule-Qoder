---
document_id: 'docs-archive-temp-t18-template-scheme-config-summary'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/design/T18-TEMPLATE-SCHEME-CONFIG-SUMMARY.md'
migrated_to: '' # 如果已迁移到openspec，填写openspec路径
tags: ['historical', 'reference', 'archived', 'temp']
...
**归档日期**: 2026-03-13
**原始路径**: docs/design/T18-TEMPLATE-SCHEME-CONFIG-SUMMARY.md

---

---

document_id: docs-design-T18-TEMPLATE-SCHEME-CONFIG-SUMMARY-md
authority: historical
status: archived
version: 0.9.0
...
source: docs
path: design/T18-TEMPLATE-SCHEME-CONFIG-SUMMARY.md
