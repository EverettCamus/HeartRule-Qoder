---
document_id: 'docs-archive-test-ai-ask-variable-extraction-regression-tests'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/test/ai-ask-variable-extraction-regression-tests.md'
migrated_to: '' # 如果已迁移到openspec，填写openspec路径
tags: ['historical', 'reference', 'archived', 'test']
...
**归档日期**: 2026-03-13
**原始路径**: docs/test/ai-ask-variable-extraction-regression-tests.md

---

---

document_id: docs-test-ai-ask-variable-extraction-regression-tests-md
authority: historical
status: archived
version: 1.0.0
...
source: docs
path: test/ai-ask-variable-extraction-regression-tests.md
tags: [historical, reference, archived, test-report]
search_priority: low
