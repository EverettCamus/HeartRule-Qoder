---
document_id: 'docs-archive-misc-yaml-format-button-demo'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/design/YAML_FORMAT_BUTTON_DEMO.md'
...
**归档日期**: 2026-03-13
**原始路径**: docs/design/YAML_FORMAT_BUTTON_DEMO.md

---

---

document_id: docs-design-YAML_FORMAT_BUTTON_DEMO-md
authority: historical
status: archived
version: 0.9.0
...
source: docs
path: design/YAML_FORMAT_BUTTON_DEMO.md
