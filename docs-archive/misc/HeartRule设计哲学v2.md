---
document_id: 'docs-archive-misc-heartrule----v2'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/design/thinking/HeartRule设计哲学v2.md'
...
**归档日期**: 2026-03-13
**原始路径**: docs/design/thinking/HeartRule设计哲学v2.md
...
| **活容器**   | ScriptRegistry动态加载，支持版本管理     | 容器是活的，内容可迭代进化   |
| **AI执行体** | 统一BaseAction接口，所有流派实现相同接口 | AI角色一致：执行者，非创造者 |
| **经验沉淀** | 编码-解码-反馈循环，StrategyAdapter模式  | 支持经验的持续积累与优化     |
