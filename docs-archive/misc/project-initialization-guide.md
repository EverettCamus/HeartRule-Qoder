---
document_id: 'docs-archive-misc-project-initialization-guide'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/design/project-initialization-guide.md'
...
**归档日期**: 2026-03-13
**原始路径**: docs/design/project-initialization-guide.md
