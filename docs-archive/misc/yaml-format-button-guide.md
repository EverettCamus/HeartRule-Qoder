---
document_id: 'docs-archive-misc-yaml-format-button-guide'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/design/yaml-format-button-guide.md'
...
**归档日期**: 2026-03-13
**原始路径**: docs/design/yaml-format-button-guide.md

---

---

document_id: docs-design-yaml-format-button-guide-md
authority: historical
status: archived
version: 0.9.0
...
source: docs
path: design/yaml-format-button-guide.md
