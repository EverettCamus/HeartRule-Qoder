---
document_id: 'docs-archive-misc-action--ai-ask--topic------'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/design/thinking/Action层(ai_ask)与Topic层的职能边界.md'
...
**归档日期**: 2026-03-13
**原始路径**: docs/design/thinking/Action层(ai_ask)与Topic层的职能边界.md
