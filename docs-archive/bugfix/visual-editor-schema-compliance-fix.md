---
document_id: 'docs-archive-bugfix-visual-editor-schema-compliance-fix'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/bugfix/visual-editor-schema-compliance-fix.md'
...
**归档日期**: 2026-03-13
**原始路径**: docs/bugfix/visual-editor-schema-compliance-fix.md

---

---

document_id: docs-bugfix-visual-editor-schema-compliance-fix-md
authority: historical
status: archived
version: 1.0.0
...
source: docs
path: bugfix/visual-editor-schema-compliance-fix.md
tags: [historical, reference, archived, bugfix]
search_priority: low
