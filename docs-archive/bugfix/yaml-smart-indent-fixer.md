---
document_id: 'docs-archive-bugfix-yaml-smart-indent-fixer'
authority: 'historical'
status: 'archived'
archived_date: '2026-03-13'
source: 'docs'
path: 'docs/design/yaml-smart-indent-fixer.md'
...
**归档日期**: 2026-03-13
**原始路径**: docs/design/yaml-smart-indent-fixer.md

---

---

document_id: docs-design-yaml-smart-indent-fixer-md
authority: historical
status: archived
version: 0.9.0
...
source: docs
path: design/yaml-smart-indent-fixer.md
