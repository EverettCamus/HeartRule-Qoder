  ...
  (
    ...
    const scrollToTarget = (focusPath: {
      ...
      if (
        ...
        // 查找 Phase Panel
        targetElement = containerRef.current.querySelector(`[data-phase-path="${phaseIndex}"]`);
      }
      ...
      return (
        <div className="action-node-list-empty">
          <Space direction="vertical" align="center" size="large">
            ...
            {onAddPhase && (
              <Button type="primary" icon={<PlusOutlined />} size="large" onClick={onAddPhase}>
                Create First Phase
              </Button>
            )}
          </Space>
        ...
        >
          <Space direction="vertical" style={{ width: '100%' }} size="small">
            ...
            <Space size={4} wrap>
              ...
              {'exit_condition' in action && action.exit_condition && (
