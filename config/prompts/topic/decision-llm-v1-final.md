# Topic决策引擎 - Decision Prompt Template (v1-final)
...
2. **用户抗拒**：用户明确表示不愿继续当前话题（此时应设置SKIP_ENTITY策略）
    ...
    "entities": [
      {
        ...
        "actionsNeeded": [
          {
            "type": "ai_say",
            "purpose": "引出妈妈的话题，建立情感连接",
            "priority": "high"
          },
          {
            "type": "ai_ask",
            "purpose": "询问妈妈的基本信息（姓名、关系、角色）",
            "priority": "high",
            "variableTargets": ["caregiver_1_name", "caregiver_1_relationship", "caregiver_1_role"]
          }
        ],
        "context": {
          "conversationSnippet": "后来妈妈也回来了",
          "existingKnowledge": "妈妈是后来回来的抚养者",
          "emotionalTone": "中性"
        }
      },
      {
        ...
        "actionsNeeded": [
          {
            ...
            "purpose": "询问外公的基本信息",
            "priority": "medium",
            "variableTargets": ["caregiver_2_name", "caregiver_2_relationship"]
          }
        ],
        "context": {
          "conversationSnippet": "外公也经常来帮忙",
          "existingKnowledge": "外公经常来帮忙",
          "emotionalTone": "积极"
        }
      },
      {
        ...
        "actionsNeeded": [
          {
            "type": "ai_ask",
            "purpose": "询问童年时期与爸爸的关系史",
            "priority": "high",
            "variableTargets": ["caregiver_0_relationship_history"]
          }
        ],
        "context": {
          "conversationSnippet": "主要是爸爸",
          "existingKnowledge": "爸爸是主要抚养者，基本信息已收集",
          "emotionalTone": "中性"
        }
      }
    ],
...
- 对话："爸爸叫李明，他是工程师。我们关系还不错，但他工作很忙。是的，他经常加班，有时候我晚上都见不到他。"
- 已有实体：爸爸（index=0，基本信息已收集）
...
```json
{
  ...
  "reasoning": "爸爸的基本信息已收集，但情感连接和关系质量需要深化探索，用户提到'有时候我晚上都见不到他'暗示可能存在情感距离",
  "adjustmentPlan": {
    "entities": [
      {
        "entityName": "爸爸",
        ...
        "actionsNeeded": [
          {
            "type": "ai_say",
            "purpose": "表达共情，建立安全空间讨论情感话题",
            "priority": "high"
          },
          {
            "type": "ai_ask",
            "purpose": "探索爸爸工作忙对亲子关系的影响",
            "priority": "high",
            "variableTargets": ["caregiver_0_work_impact"]
          },
          {
            "type": "ai_ask",
            "purpose": "询问童年时期对爸爸的情感体验",
            "priority": "medium",
            "variableTargets": ["caregiver_0_childhood_emotion"]
          },
          {
            "type": "ai_think",
            "purpose": "评估父子情感连接质量",
        ...
        "context": {
          "conversationSnippet": "他经常加班，有时候我晚上都见不到他",
          "existingKnowledge": "爸爸叫李明，工程师，工作很忙，关系还不错",
          "emotionalTone": "略带遗憾"
        }
      }
    ],
    "insertionStrategy": "INSERT_AFTER_CURRENT",
    "targetPosition": {
      "afterActionId": "current_topic_action"
    }
  },
  "constraints": {
    "maxTotalActions": 6,
    "maxActionsPerEntity": 4,
    "timeBudgetMinutes": 3,
    "forbiddenActionTypes": ["use_skill"]
  }
}
```
...
- 对话："爸爸和妈妈我都说过了。爷爷...我不想谈爷爷。"
- 已有实体：爸爸（index=0）、妈妈（index=1）
...
```json
{
  ...
  "reasoning": "用户明确表示'我不想谈爷爷'，应尊重用户意愿跳过该实体。爸爸和妈妈需要深化关系史探索。",
  "adjustmentPlan": {
    "entities": [
      {
        "entityName": "爷爷",
        ...
        "actionsNeeded": [],
        "context": {
          "conversationSnippet": "爷爷...我不想谈爷爷",
          "existingKnowledge": "用户提到爷爷但不愿讨论",
          "emotionalTone": "抗拒"
        }
      },
      {
        ...
        "actionsNeeded": [
          {
            "type": "ai_ask",
            "purpose": "询问童年时期与爸爸的关系细节",
            "priority": "high",
            "variableTargets": ["caregiver_0_relationship_detail"]
          }
        ],
        "context": {
          "conversationSnippet": "爸爸是工程师，他们对我都挺好的",
          "existingKnowledge": "爸爸是工程师，关系良好",
          "emotionalTone": "积极"
        }
      },
      {
        ...
        "actionsNeeded": [
          {
            "type": "ai_ask",
            "purpose": "询问童年时期与妈妈的关系细节",
            "priority": "high",
            "variableTargets": ["caregiver_1_relationship_detail"]
          }
        ],
        "context": {
          "conversationSnippet": "妈妈是老师，他们对我都挺好的",
          "existingKnowledge": "妈妈是老师，关系良好",
          "emotionalTone": "积极"
        }
      }
    ],
