---
document_id: product-ai-ask-multi-variable-output-feature-guide
authority: product
status: active
version: 1.0.0
last_updated: 2026-03-01
source: docs/ai_ask_output_list_feature.md
path: product/feature-guides/ai-ask-multi-variable-output-feature-guide.md
tags: [product, feature-guide, ai-ask, output-list, multi-variable, configuration]
search_priority: high
language: zh
needs_translation: false
related_documents:
  - product/feature-guides/topic-configuration-guide.md
  - product/feature-guides/topic-dynamic-action-queue-intelligent-capability-requirements.md
  - domain/tactical/action-topic-responsibility-boundary.md
---
